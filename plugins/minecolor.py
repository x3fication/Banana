def mcparse(text): # yes this is retarded but if it works don't touch it 😂😂😂
    text = str(text).replace('§0', '\033[30m').replace('§1', '\033[34m').replace('§2', '\033[32m').replace('§3', '\033[36m')\
